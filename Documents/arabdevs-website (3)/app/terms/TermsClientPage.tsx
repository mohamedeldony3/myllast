          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground leading-relaxed">
              ...
              <section>
                ...
                <p>
                  Arabdevs provides professional web development, mobile application development, and related software
                  development services. The specific scope of services will be defined in individual project agreements.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  Unless otherwise specified in a project agreement, all intellectual property rights in deliverables
                  will be transferred to the client upon full payment. Arabdevs retains the right to showcase completed
              ...
              <section>
                <h2 className="text-2xl font-semibold text-foreground mb-4">6. Project Timeline</h2>
                <p>
                  Project timelines are estimates and may be subject to change based on project complexity, client
                  feedback, and other factors. We will communicate any significant delays promptly.
                </p>
              </section>
